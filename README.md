...
4.4. [TF Tree](#tf-tree)    
4.5. [Load the URDF in Gazebo](#load-the-urdf-in-gazebo)  
...
>This part is optional, if you are interested you can do it. Add this file to urdf folder [dume_bot.urdf](https://drive.google.com/file/d/1Qt583ONvU4sfDFmD9CbT9lwTHsVVvBzI/view?usp=sharing) and jump to [Load the URDF in Gazebo](#load-the-urdf-in-gazebo) part.
